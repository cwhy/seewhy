"""
Generate a self-contained HTML report for exp23 (CIFAR-10, LATENT=512).

Usage:
    uv run python scripts/tmp/gen_html_report_exp23.py
"""
...
<p class="subtitle">
  {EXP} &nbsp;·&nbsp; CIFAR-10 &nbsp;·&nbsp; CNN encoder + wide deconvnet, LATENT={latent_dim} &nbsp;·&nbsp;
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">vs exp20 baseline</div><div class="value">LATENT {latent_dim}d</div></div>
  ...
  <p>
    exp23 expands the latent from 128 to {latent_dim} dimensions — the only change from exp20.
    Hypothesis: the reconstruction plateau at 0.0046 across exp15–exp22 is caused by 24×
    latent compression. At 6× compression ({latent_dim}-d), the encoder can preserve texture detail.
  </p>
</div>
...
<table>
  ...
  <tr><td>Content vector (latent)</td><td><strong>{latent_dim} dimensions</strong> (was 128 in exp15–exp22)</td></tr>
...
<footer>
  ...
  CIFAR-10 &nbsp;·&nbsp; LATENT={latent_dim} wide-deconvnet &nbsp;·&nbsp; generated 2026-04-16
</footer>
</body>
</html>
"""

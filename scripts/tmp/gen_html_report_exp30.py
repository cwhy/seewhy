"""
Generate a self-contained HTML report for exp30 (CIFAR-10, LATENT=1024).

Usage:
    uv run python scripts/tmp/gen_html_report_exp30.py
"""
...
<div class="summary-card">
  ...
  <p>
    exp30 expands the latent from 512 to {latent_dim} dimensions and ENC_FC1 from 512 to {enc_fc1}.
    Hypothesis: each LATENT doubling (64→128→512) halved MSE. At {latent_dim}-d (3× compression),
    the model expected to push below 0.0015.
  </p>
</div>

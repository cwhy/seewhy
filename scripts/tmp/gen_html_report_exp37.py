"""
Generate a self-contained HTML report for exp37 (Global IMLE, CIFAR-10, no recon loss).
Requires plots already generated by:
    CUDA_VISIBLE_DEVICES=0 uv run python projects/variations/scripts/gen_report_exp37.py

Usage:
    uv run python scripts/tmp/gen_html_report_exp37.py
"""
...
<div class="summary-card">
  ...
  <p>
    exp37 replaces local IMLE (precomputed kNN per image) with <strong>global IMLE</strong>:
...
<table>
  <tr><th>Metric</th><th>exp33 (local IMLE, K=16)</th><th>exp35 (warm-start)</th><th>exp37 (global IMLE)</th></tr>

"""
Generate a self-contained HTML report for exp27 (CIFAR-10, LATENT=1024).

Usage:
    uv run python scripts/tmp/gen_html_report_exp27.py
"""
...
<div class="summary-card">
  ...
  <p>
    exp27 expands the latent from 512 to {latent_dim} dimensions and ENC_FC1 from 512 to {enc_fc1}.
    Hypothesis: each LATENT doubling (64→128→512) halved MSE. At {latent_dim}-d (3× compression),
    the model may break below 0.0020 reconstruction MSE.
  </p>
</div>
...
<footer>
  ...
  CIFAR-10 &nbsp;·&nbsp; LATENT={latent_dim} wide-deconvnet &nbsp;·&nbsp; generated 2026-04-17
</footer>
</body>
</html>
"""

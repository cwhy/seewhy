"""
Run exp20, exp21, exp22 sequentially (one GPU process at a time).

Usage:
    uv run python scripts/tmp/run_exp20_21_22_sequential.py
"""
...
for exp in EXPS:
    ...
    # Run report if it exists, skip if not (report scripts can be added later)

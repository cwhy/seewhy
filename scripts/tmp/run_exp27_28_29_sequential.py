"""
Run exp27, exp28, exp29 sequentially (one GPU process at a time).

Usage:
    uv run python scripts/tmp/run_exp27_28_29_sequential.py
"""
...
for exp in EXPS:
    ...
    # Run report if it exists, skip if not

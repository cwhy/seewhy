"""
Generate a self-contained HTML report for exp28 (CIFAR-10, N_VAR=128).

Usage:
    uv run python scripts/tmp/gen_html_report_exp28.py
"""
...
fig.suptitle(f"Learning dynamics — {EXP} (CIFAR-10, N_VAR={n_var})", fontsize=14, fontweight="bold", y=1.01)
plt.tight_layout()
...
<p class="subtitle">
  {EXP} &nbsp;·&nbsp; CIFAR-10 &nbsp;·&nbsp; CNN encoder + wide deconvnet, LATENT={latent_dim}, N_VAR={n_var} &nbsp;·&nbsp;
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">vs exp23 baseline</div><div class="value">N_VAR {n_var}</div></div>
  ...
  <p>
    exp28 doubles IMLE coverage from 64 to {n_var} style candidates per batch.
    Hypothesis: exp23 L_var plateaus early (~0.00948) because only 64 candidates are sampled;
    more candidates = better matching of kNN neighbors, lower L_var plateau, better recall MSE.
  </p>
</div>
...
<table>
  ...
  <tr><td>Variation candidates / step</td><td><strong>{n_var} random style codes</strong> (was 64 in exp23)</td></tr>
...
<footer>
  ...
  CIFAR-10 &nbsp;·&nbsp; LATENT={latent_dim} N_VAR={n_var} wide-deconvnet &nbsp;·&nbsp; generated 2026-04-17
</footer>
</body>
</html>
"""

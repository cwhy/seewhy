"""
Generate a self-contained HTML report for exp32 (CIFAR-10, LATENT=2048).

Usage:
    uv run python scripts/tmp/gen_html_report_exp32.py
"""
...
<p class="subtitle">
  {EXP} &nbsp;·&nbsp; CIFAR-10 &nbsp;·&nbsp; CNN encoder + wide deconvnet, LATENT={latent_dim}, 200 epochs &nbsp;·&nbsp;
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">vs exp30 baseline</div><div class="value">LATENT {latent_dim}d</div></div>
  ...
  <p>
    exp32 expands the latent from 1024 to {latent_dim} dimensions and ENC_FC1 from 1024 to {enc_fc1}.
    LATENT doubling law: 512→1024 at 200ep gave −25% (0.00165→0.00124).
    At {latent_dim}-d, another ~−25% expected.
  </p>
</div>
...
<table>
  ...
  <tr><td>Content vector (latent)</td><td><strong>{latent_dim} dimensions</strong> (was 1024 in exp30)</td></tr>

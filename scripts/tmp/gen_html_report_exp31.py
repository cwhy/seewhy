"""
Generate a self-contained HTML report for exp31 (CIFAR-10, LATENT=1024).

Usage:
    uv run python scripts/tmp/gen_html_report_exp31.py
"""
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">vs exp23 baseline</div><div class="value">LATENT {latent_dim}d</div></div>
  ...
  <p>
    exp31 expands the latent from 512 to {latent_dim} dimensions and ENC_FC1 from 512 to {enc_fc1}.
    Hypothesis: each LATENT doubling (64→128→512) halved MSE. At {latent_dim}-d (3× compression),
    the model expected to be the best model in this series.
  </p>
</div>
...
<table>
  ...
  <tr><td>Content vector (latent)</td><td><strong>{latent_dim} dimensions</strong> (was 512 in exp23)</td></tr>

"""
Generate a self-contained HTML report for exp33 (CIFAR-10, LATENT=2048, N_VAR=128).

Usage:
    uv run python scripts/tmp/gen_html_report_exp33.py
"""
...
fig.suptitle(f"Learning dynamics — {EXP} (CIFAR-10, LATENT={latent_dim})", fontsize=14, fontweight="bold", y=1.01)
plt.tight_layout()
...
<head>
  ...
  <title>Learning to Generate Image Variations — {EXP} (CIFAR-10, LATENT={latent_dim})</title>
  <style>
...
<p class="subtitle">
  {EXP} &nbsp;·&nbsp; CIFAR-10 &nbsp;·&nbsp; CNN encoder + wide deconvnet, LATENT={latent_dim}, N_VAR={n_var}, 200 epochs &nbsp;·&nbsp;
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">vs exp31 baseline</div><div class="value">LATENT {latent_dim}d</div></div>
  ...
  <p>
    exp33 expands the latent from 1024 to {latent_dim} dimensions and ENC_FC1 from 1024 to {enc_fc1}.
    Combines LATENT=2048, N_VAR=128, 200 epochs, and chunked lax.scan (2× speedup over exp31 step loop).
    Expected to be the best model in this series.
  </p>
</div>
...
<table>
  ...
  <tr><td>Content vector (latent)</td><td><strong>{latent_dim} dimensions</strong> (was 1024 in exp31)</td></tr>
...
<footer>
  ...
  CIFAR-10 &nbsp;·&nbsp; LATENT={latent_dim} wide-deconvnet &nbsp;·&nbsp; generated 2026-04-18
</footer>
</body>
</html>
"""

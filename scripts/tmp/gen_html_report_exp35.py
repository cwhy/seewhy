"""
Generate a self-contained HTML report for exp35 (CIFAR-10, LATENT=2048, N_VAR=128, warm-start exp33).

Usage:
    uv run python scripts/tmp/gen_html_report_exp35.py
"""
...
warm_start   = result.get("warm_start", "exp33")
...
fig.suptitle(f"Learning dynamics — {EXP} (CIFAR-10, LATENT={latent_dim}, warm-start {warm_start})", fontsize=14, fontweight="bold", y=1.01)
plt.tight_layout()
...
<head>
  ...
  <title>Learning to Generate Image Variations — {EXP} (CIFAR-10, warm-start {warm_start})</title>
  <style>
...
<p class="subtitle">
  {EXP} &nbsp;·&nbsp; CIFAR-10 &nbsp;·&nbsp; CNN encoder + wide deconvnet, LATENT={latent_dim}, N_VAR={n_var}, 200 epochs, warm-start {warm_start} &nbsp;·&nbsp;
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">Warm start</div><div class="value">{warm_start}</div></div>
  ...
  <p>
    exp35 loads {warm_start} parameters and resets the optimizer state, then trains for 200 more epochs
    with a fresh cosine LR schedule (3×10⁻⁴ restart). Tests whether exp33 was training-limited
    (recall improves) or capacity-limited (recall stagnates near 0.0073).
  </p>
</div>
...
<table>
  ...
  <tr><td>Warm start</td><td><strong>{warm_start}</strong> params loaded, optimizer reset, fresh cosine LR</td></tr>
...
<footer>
  ...
  CIFAR-10 &nbsp;·&nbsp; LATENT={latent_dim} warm-start {warm_start} wide-deconvnet &nbsp;·&nbsp; generated 2026-04-19
</footer>
</body>
</html>
"""

"""
Generate a self-contained HTML report for exp16 (CIFAR-10, CNN encoder).
All plots are embedded as base64 PNGs. Uploads to R2.

Usage:
    uv run python scripts/tmp/gen_html_report_exp16.py
"""
...
fig.suptitle("Learning dynamics — exp16 (CIFAR-10, CNN encoder)", fontsize=14, fontweight="bold", y=1.01)
plt.tight_layout()
...
<head>
  ...
  <title>Learning to Generate Image Variations — exp16 (CIFAR-10, CNN encoder)</title>
  <style>
...
<p class="subtitle">
  exp16 &nbsp;·&nbsp; CIFAR-10 &nbsp;·&nbsp; CNN encoder + deconvnet decoder &nbsp;·&nbsp;
...
<div class="summary-card">
  ...
  <div class="metrics">
    ...
    <div class="metric"><div class="label">vs exp15 (MLP enc)</div><div class="value">−0.0006</div></div>
  ...
  <p>
    exp16 replaces the MLP encoder from exp15 with a CNN encoder: three stride-2 convolutional
    layers (3→{enc_c1}→{enc_c2}→{enc_c3} channels) progressively downsample 32×32 to 4×4,
    followed by a two-layer FC head projecting to {latent_dim}-d. The decoder is unchanged.
    Reconstruction MSE improves from 0.0049 (exp15) to <code>{final_mse:.4f}</code>,
    confirming that convolutional feature extraction is better suited to 32×32 RGB images.
    Training time is unchanged since the decoder dominates the compute budget.
  </p>
...
<h3>CNN Encoder (new in exp16)</h3>
<div class="diagram">
  x_flat (B, 3072)
...
<h3>Decoder (unchanged from exp15)</h3>
<div class="diagram">
...
<footer>
  Conditioned variation model &nbsp;·&nbsp; exp16 &nbsp;·&nbsp;
  CIFAR-10 &nbsp;·&nbsp; CNN encoder + deconvnet decoder &nbsp;·&nbsp; generated 2026-04-15
</footer>
</body>
</html>
"""

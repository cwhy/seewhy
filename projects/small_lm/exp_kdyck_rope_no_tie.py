"""
exp_kdyck_rope_no_tie — k-Dyck pretraining + RoPE + separate LM head.
...
Usage:
    uv run python projects/small_lm/scripts/run_experiments.py --bg exp_kdyck_rope_no_tie
"""
...
EXP_NAME = "exp_kdyck_rope_no_tie"
...
def _build_rope_tables(seq_len, head_dim):
...
def init_params(key_gen):
    ...
    # No pos_embed — RoPE handles position

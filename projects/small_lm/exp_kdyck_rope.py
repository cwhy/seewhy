"""
exp_kdyck_rope — k-Dyck procedural pre-training + RoPE positional encoding.
...
What changed vs exp_kdyck:
  ...
  - forward() does not add pos_embed to token embeddings

Usage:
    uv run python projects/small_lm/scripts/run_experiments.py --bg exp_kdyck_rope
"""

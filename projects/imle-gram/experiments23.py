"""
exp23 — 512-cluster flat clustering with delta_sum assignment.
...
Usage:
    uv run python projects/imle-gram/experiments23.py
"""
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment": EXP_NAME,
        "name": f"imle-cluster-deltasum N_CODES={N_CODES} D_EMB={D_EMB} D_U={D_U}",

"""
exp1 — Gram IMLE: basic IMLE with gram decoder (no encoder).
...
Decoder: identical to vae-gram/exp19 (MLP_HIDDEN=256, DEC_RANK=16, D=144, LATENT_DIM=64).
...
SEED        = 42
MAX_EPOCHS  = 100
N_SAMPLES   = 1000   # latent codes sampled per epoch for NN matching

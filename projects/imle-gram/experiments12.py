"""
exp12 — Shared codebook + P_ZERO=0.9 (10% non-zero per free slot).

~1.5 active slots per sample on average (vs ~7.5 in exp10).

Usage:
    uv run python projects/imle-gram/experiments12.py
"""
...
TEMP       = 10.0
P_ZERO     = 0.9   # probability each free slot is code 0 (~1.5 active slots)

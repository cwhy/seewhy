"""
exp20 — 128-cluster flat clustering (load-balanced, mean-split).

Same architecture as exp17c (N_VARS=1 Hebbian, load-balanced mean-split
assignment) with N_CODES=128.

Scales up exp18 from 49 to 128 clusters.

Usage:
    uv run python projects/imle-gram/experiments20.py
"""

"""
exp11 — Shared codebook + P_ZERO=0.8 (20% non-zero per free slot).

~3 active slots per sample on average (vs ~7.5 in exp10).

Usage:
    uv run python projects/imle-gram/experiments11.py
"""
...
TEMP       = 10.0
P_ZERO     = 0.8   # probability each free slot is code 0 (~3 active slots)

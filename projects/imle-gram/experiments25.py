"""
exp25 — Fashion-MNIST 512-cluster flat delta_sum.

Identical to exp23 but trained on Fashion-MNIST.

Same architecture as exp21 (N_VARS=1 Hebbian, delta_sum assignment),
scaled to N_CODES=512.

Compare with:
  exp21  — 128-cluster flat delta_sum
  exp22  — 8×8×8 factored (same 512 capacity, three variables)

Usage:
    uv run python projects/imle-gram/experiments25.py
"""
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment": EXP_NAME,
        "name": f"fmnist-cluster-deltasum N_CODES={N_CODES} D_EMB={D_EMB} D_U={D_U}",

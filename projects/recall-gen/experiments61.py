"""Recall-Gen — exp61: the M=64 cell again at twice the training budget.
...
Everything else is exp59: same width, heads, depth, learning rate, seed, pool,
batch and mask schedule.

Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp61
"""
...
RN = Run(
    exp_name="smoke_exp61" if SMOKE else "exp61",
    name="synthetic prior, delta rule, train M=64 (long pool, double budget)",
    domain="synth_long",

...
model that ignores its context scores zero. Unlike identification accuracy, gain
cannot be inflated by a model whose completions merely happen to be good enough
to pick the right neighbour — which matters, because at large $M$ that is what
happens.

"""Recall-Gen — exp37: train on Fashion-MNIST, test on MNIST, completion training
...
Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp37
"""
...
RN = Run(
    exp_name="smoke_exp37" if SMOKE else "exp37",
    name="cross-dataset: train on Fashion-MNIST, novel pool is MNIST, completion training",

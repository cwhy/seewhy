"""Recall-Gen — exp31: Fashion-MNIST class split, completion training
...
Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp31
"""
...
RN = Run(
    exp_name="smoke_exp31" if SMOKE else "exp31",
    name="class split: train on Fashion-MNIST 0-4, novel pool is 5-9, completion training",

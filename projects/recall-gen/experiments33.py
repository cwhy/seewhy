"""Recall-Gen — exp33: chess phase split, recall training
...
Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp33
"""
...
RN = Run(
    exp_name="smoke_exp33" if SMOKE else "exp33",
    name="phase split: train on 24+ piece positions, novel pool is endgames, recall training",
    domain="chess",

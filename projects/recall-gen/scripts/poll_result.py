...
Usage:
    uv run python projects/recall-gen/scripts/poll_result.py exp1
    uv run python projects/recall-gen/scripts/poll_result.py --all
    uv run python projects/recall-gen/scripts/poll_result.py exp1 --interval 5
"""

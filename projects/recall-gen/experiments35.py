"""Recall-Gen — exp35: chess phase split, recall training, KDA layers frozen at init
...
Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp35
"""
...
RN = Run(
    exp_name="smoke_exp35" if SMOKE else "exp35",
    name="phase split 24+ pieces, chess, recall training, KDA layers frozen at init",
    domain="chess",

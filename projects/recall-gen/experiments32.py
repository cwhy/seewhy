"""Recall-Gen — exp32: Fashion-MNIST class split, recall training, KDA layers frozen at init
...
Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp32
"""
...
RN = Run(
    exp_name="smoke_exp32" if SMOKE else "exp32",
    name="class split 0-4 Fashion-MNIST, recall training, KDA layers frozen at init",

"""Recall-Gen — exp51: the frozen-layer arm at twice the width.
...
This is the frozen-layer counterpart of exp49, so the three arms can be compared again
at a width where the recall arm demonstrably works.

Usage:
    uv run --no-sync python projects/recall-gen/scripts/run_experiments.py --bg exp51
"""
...
RN = Run(
    exp_name="smoke_exp51" if SMOKE else "exp51",
    name="synthetic prior, frozen-layer arm, d_model=512",
    domain="synth",

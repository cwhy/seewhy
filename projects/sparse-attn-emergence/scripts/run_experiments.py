"""
Experiment runner for Sparse-Attention Emergence.

Runs experiments sequentially (default) or in parallel across GPUs.
Logs each experiment to projects/sparse-attn-emergence/logs/{name}.log and prints a
...
Usage:
    ...
    uv run python projects/sparse-attn-emergence/scripts/run_experiments.py --viz scripts/gen_viz_exp1.py exp1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run Sparse-Attention Emergence experiments")

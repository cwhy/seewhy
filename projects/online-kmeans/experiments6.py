"""
exp6 — Spherical K-means (cosine), N_CODES=512.

Same as exp5 but with 4x more clusters.

Compare with:
  exp5 — spherical K-means N_CODES=128
  exp4 — lloyd K-means N_CODES=512 (cosine similarity) on raw MNIST pixels.

"""
Experiment runner for AR-Recall.

Runs experiments sequentially (default) or in parallel across GPUs.
Logs each experiment to projects/ar-recall/logs/{name}.log and prints a
...
Usage:
    ...
    uv run python projects/ar-recall/scripts/run_experiments.py --viz scripts/gen_viz_exp1.py exp1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run AR-Recall experiments")

"""
exp21 — DiVeQ with product quantization (G=4 groups, K=256 per group).
...
Architecture:
    ...
    DiVeQ-PQ     G=4 groups of 4 dims, each with K=256 codewords → 36 bits
...
LATENT_DIM    = 16
N_GROUPS      = 8            # product quantization groups
...
def init_params(key_gen):
    ...
    # One codebook per group: (G, K, D_g)
    params["codebooks"] = u(

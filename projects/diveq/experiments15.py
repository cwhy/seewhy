"""
exp15 — DiVeQ with product quantization (G=4 groups, K=512 per group).
...
LATENT_DIM    = 16
N_GROUPS      = 4            # product quantization groups
GROUP_DIM     = LATENT_DIM // N_GROUPS   # = 4 dims per group
CODEBOOK_SIZE = 512          # K per group; total bits = N_GROUPS * log2(K) = 36
SIGMA         = 0.01
HIDDEN        = 512
BATCH_SIZE    = 128
MAX_EPOCHS    = 500

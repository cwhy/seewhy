"""
exp2 — DiVeQ on MNIST: VQ-VAE with Distributional Vector Quantization.
...
LATENT_DIM    = 16
CODEBOOK_SIZE = 128        # K codewords (7 bits)
SIGMA         = 0.001       # noise std; paper shows accuracy improves as σ² → 0
HIDDEN        = 512
BATCH_SIZE    = 128
MAX_EPOCHS    = 50
ADAM_LR       = 3e-4

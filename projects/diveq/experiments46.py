...
Target: within ~5% of ceiling (0.00181) at 500ep → ≈0.0019.
"""
...
if __name__ == "__main__":
    ...
    logging.info(
        ...
        f"bits={total_bits}  sigma={SIGMA}  HIDDEN={HIDDEN}  (running-stats BN, 500ep)"
    )
    ...
    append_result({
        "experiment":         EXP_NAME,
        "name":               f"DiVeQ-PQ+BN G={N_GROUPS} K={CODEBOOK_SIZE} D_g={GROUP_DIM} bits={total_bits} 500ep",

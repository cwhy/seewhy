"""
exp4 — LeWM JEPA on MNIST: larger embedding (LATENT_DIM 64 → 128).

vs exp2 (best so far, 89.4%): same random 50% masking, double the embedding size.
...
Usage:
    uv run python projects/ssl/experiments4.py
"""
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment"      : EXP_NAME,
        "name"            : f"jepa-gram mask=random50% LATENT={LATENT_DIM} LAMBDA={LAMBDA} DEC_RANK={DEC_RANK}",

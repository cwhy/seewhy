"""
exp9a — LeWM JEPA on MNIST: encoder capacity — DEC_RANK=64 LATENT_DIM=128.

vs exp7c (95.4%): DEC_RANK=64 LATENT_DIM=128, else identical.
...
Usage:
    uv run python projects/ssl/exp9a.py
"""

"""
exp_mlp_ema_noaug_1024 — MLP encoder + EMA + NO augmentation, LATENT_DIM=1024.
...
Usage:
    uv run python projects/ssl/exp_mlp_ema_noaug_1024.py
"""
...
EXP_NAME = "exp_mlp_ema_noaug_1024"

"""
exp_vae_mlp2 — MLP-deep encoder + VAE, LATENT_DIM=1024.

Training: Variational autoencoder, beta-VAE (BETA=0.01), encode returns mu at eval.

Usage:
    uv run python projects/ssl/exp_vae_mlp2.py
"""
...
if __name__ == "__main__":
    ...
    logging.info(f"BETA = {BETA}  arch = 'MLP-deep'")

"""
exp5a — LeWM JEPA on MNIST: DEC_RANK=32 MLP_HIDDEN=256.

vs exp4 (91.1%): same random 50% masking, LATENT_DIM=128. DEC_RANK=32 MLP_HIDDEN=256.
...
Usage:
    uv run python projects/ssl/exp5a.py
"""

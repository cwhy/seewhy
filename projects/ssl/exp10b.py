"""
exp10b — LeWM JEPA on MNIST: encoder capacity — DEC_RANK=64 LATENT_DIM=512.

vs exp9c (95.8%): DEC_RANK=64 LATENT_DIM=512, else identical.
...
Usage:
    uv run python projects/ssl/exp10b.py
"""

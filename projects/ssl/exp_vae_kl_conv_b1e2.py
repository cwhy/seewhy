"""
exp_vae_conv — ConvNet-v1 encoder + VAE, LATENT_DIM=1024.

Training: Variational autoencoder, beta-VAE (BETA=0.01), encode returns mu at eval.

Usage:
    uv run python projects/ssl/exp_vae_conv.py
"""
...
if __name__ == "__main__":
    ...
    logging.info(f"BETA = {BETA}  arch = 'ConvNet-v1'")

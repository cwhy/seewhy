"""
exp9b — LeWM JEPA on MNIST: encoder capacity — DEC_RANK=32 LATENT_DIM=256.

vs exp7c (95.4%): DEC_RANK=32 LATENT_DIM=256, else identical.
...
Usage:
    uv run python projects/ssl/exp9b.py
"""

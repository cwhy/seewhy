"""
exp5b —LeWM JEPA on MNIST: DEC_RANK=16 MLP_HIDDEN=512.

vs exp4 (91.1%): same random 50% masking, LATENT_DIM=128. DEC_RANK=16 MLP_HIDDEN=512.
...
Usage:
    uv run python projects/ssl/exp5b.py
"""

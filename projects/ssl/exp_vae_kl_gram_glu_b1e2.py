"""
exp_vae_gram_glu — Gram-GLU encoder + VAE, LATENT_DIM=1024.

Training: Variational autoencoder, beta-VAE (BETA=0.01), encode returns mu at eval.

Usage:
    uv run python projects/ssl/exp_vae_gram_glu.py
"""
...
EXP_NAME = "exp_vae_kl_gram_glu_b1e2"
...
if __name__ == "__main__":
    ...
    logging.info(f"BETA = {BETA}  arch = 'Gram-GLU'")

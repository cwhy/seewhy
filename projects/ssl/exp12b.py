...
Usage:
    uv run python projects/ssl/exp12b.py
"""
...
def init_params(key_gen):
    ...
    return {
        ...
        "W_enc1"      : n((DEC_RANK**2, MLP_HIDDEN), scale=(DEC_RANK**2)**-0.5),  # (1024, 512)
        "b_enc1"      : jnp.zeros(MLP_HIDDEN),
        "W_enc2"      : n((MLP_HIDDEN, LATENT_DIM), scale=MLP_HIDDEN**-0.5),      # (512, 1024)

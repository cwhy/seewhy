"""
exp_dae_gram_single — Gram-single encoder + DAE, LATENT_DIM=1024.

Training: Denoising autoencoder, 4 augmentations (gaussian noise + 3 masking levels), MSE to clean target.

Usage:
    uv run python projects/ssl/exp_dae_gram_single.py
"""

"""
exp_sigreg_gram_single — Gram-single encoder + SIGReg-JEPA, LATENT_DIM=1024.
...
EMA counterpart: exp_gram_single_ema_1024

Usage:
    uv run python projects/ssl/exp_sigreg_gram_single.py
"""

"""
exp7d — LeWM JEPA on MNIST: Gaussian noise sweep NOISE_STD=100 epochs=200.

vs exp7 (93.5%, std=50, 100ep): NOISE_STD=100, MAX_EPOCHS=200.
...
Usage:
    uv run python projects/ssl/exp7d.py
"""
...
NOISE_STD  = 100.0   # Gaussian noise std in pixel units (0–255 scale)

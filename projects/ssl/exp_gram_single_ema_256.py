"""
exp_gram_single_ema_256 — Gram encoder + single-projection Hadamard + EMA, LATENT=256.
...
Usage:
    uv run python projects/ssl/exp_gram_single_ema_256.py
"""
...
EXP_NAME = "exp_gram_single_ema_256"

"""
exp5c —LeWM JEPA on MNIST: DEC_RANK=32 MLP_HIDDEN=512.

vs exp4 (91.1%): same random 50% masking, LATENT_DIM=128. DEC_RANK=32 MLP_HIDDEN=512.
...
Usage:
    uv run python projects/ssl/exp5c.py
"""
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment"      : EXP_NAME,
        "name"            : f"jepa-gram mask=random50% LATENT={LATENT_DIM} DEC_RANK={DEC_RANK} MLP_HIDDEN={MLP_HIDDEN}",

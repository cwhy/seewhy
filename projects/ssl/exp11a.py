"""
exp10a — LeWM JEPA on MNIST: encoder capacity — DEC_RANK=32 LATENT_DIM=512.

vs exp9c (95.8%): DEC_RANK=32 LATENT_DIM=512, else identical.
...
Usage:
    uv run python projects/ssl/exp10a.py
"""

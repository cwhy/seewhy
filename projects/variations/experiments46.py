...
VOCAB_SIZE    = 8
E_DIM         = 64
COND_DIM      = N_CAT * E_DIM   # 256
IN_DIM        = LATENT_DIM + COND_DIM  # 2304
BATCH_SIZE    = 64
N_VAR_SAMPLES = 128
MAX_EPOCHS    = 150
ADAM_LR       = 3e-4
...
def loss_fn(params, x_batch, cats, X_train_norm):
    ...
    cond_all = cats_to_cond(params, cats)                                     # (N_VAR, COND_DIM)
    ...
    win_cond = cats_to_cond(params, win_cats.reshape(B * K_NN, N_CAT))       # (B*K_NN, COND_DIM)

"""
exp2 — Variations: inverted IMLE matching (kNN → closest sample).
...
Usage:
    uv run python projects/variations/experiments2.py
"""
...
D              = D_R * D_C * D_V  # 144
ALPHA          = 1.0
BATCH_SIZE     = 64               # B*N_VAR_SAMPLES=1024 decode calls per step (matches exp1 memory)
N_VAR_SAMPLES  = 16               # bit patterns sampled per step for matching
MAX_EPOCHS     = 100
ADAM_LR        = 3e-4
SEED           = 42
K_NN           = 64

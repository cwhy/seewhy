"""
exp11 — exp6 + N_VAR_SAMPLES=32, K_NN=64.

Same as exp10 but keeps K_NN=64 neighbors (vs 16 in exp10).
BATCH_SIZE=64 to keep B×N_VAR=2048 decode/step.

Usage:
    uv run python projects/variations/experiments11.py
"""

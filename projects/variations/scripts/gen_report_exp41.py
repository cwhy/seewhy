"""
Generate and upload a full visualisation report for exp41
(CIFAR-10, Global IMLE, LATENT=2048, exact GPU NN, exclusive Voronoi + recon loss).

Usage:
    CUDA_VISIBLE_DEVICES=0 uv run python projects/variations/scripts/gen_report_exp41.py
"""

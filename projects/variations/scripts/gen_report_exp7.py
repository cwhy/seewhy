"""
Generate and upload a report for variations exp7.
...
Produces:
  ...
  - Local report: projects/variations/report_exp7.md
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp7.py
"""
...
md_local = f"""# variations — exp7 report

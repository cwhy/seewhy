"""
Generate and upload a report for variations exp9.
...
Produces:
  ...
  - Local report: projects/variations/report_exp9.md
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp9.py
"""
...
md_local = f"""# variations — exp9 report

"""
Generate and upload a report for variations exp14.
...
Produces:
  ...
  - Local report: projects/variations/report_exp14.md
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp14.py
"""
...
md_local = f"""# variations — exp14 report

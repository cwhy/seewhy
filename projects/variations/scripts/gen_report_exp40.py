"""
Generate and upload a full visualisation report for exp40
(CIFAR-10, Global IMLE, LATENT=2048, exact GPU NN, exclusive Voronoi + recon loss).
...
ax.set_xlabel("epoch"); ax.set_ylabel("MSE"); ax.set_title("Training loss (global IMLE + recon)")
ax.set_yscale("log")
...
fig.suptitle(f"Learning dynamics — {EXP} (CIFAR-10, Global IMLE + recon, LATENT={latent_dim})", fontsize=13)
plt.tight_layout()

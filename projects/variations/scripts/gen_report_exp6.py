"""
Generate and upload a report for variations exp6.
...
Produces:
  ...
  - Local report: projects/variations/report_exp6.md
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp6.py
"""
...
md_local = f"""# variations — exp6 report

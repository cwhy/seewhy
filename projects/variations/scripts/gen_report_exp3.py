"""
Generate and upload a report for variations exp3.
...
Produces:
  ...
  - Local report: projects/variations/report_exp3.md  (relative paths, works offline)
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp3.py
"""
...
from experiments3 import encode, decode, LATENT_DIM, N_BITS
...
md_local = f"""# variations — exp3 report

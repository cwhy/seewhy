"""
Generate and upload a report for variations exp31 (CIFAR-10, LATENT=1024).

Usage:
    uv run python projects/variations/scripts/gen_report_exp31.py
"""
...
md_local = f"""# variations — exp31 report (CIFAR-10, LATENT={LATENT_DIM})

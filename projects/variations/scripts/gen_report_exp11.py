"""
Generate and upload a report for variations exp11.
...
Produces:
  ...
  - Local report: projects/variations/report_exp11.md
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp11.py
"""
...
md_local = f"""# variations — exp11 report

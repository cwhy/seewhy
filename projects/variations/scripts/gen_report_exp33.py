"""
Generate and upload a report for variations exp33 (CIFAR-10, LATENT=2048, N_VAR=128).

Usage:
    uv run python projects/variations/scripts/gen_report_exp33.py
"""
...
md_local = f"""# variations — exp33 report (CIFAR-10, LATENT={LATENT_DIM})

**Algorithm**: CNN encoder + wide deconvnet decoder. Primary change: LATENT_DIM={LATENT_DIM} (was 1024 in exp31), ENC_FC1={ENC_FC1}.
...
| param | value |
|-------|-------|
| LATENT_DIM | {LATENT_DIM} (was 1024 in exp31) |

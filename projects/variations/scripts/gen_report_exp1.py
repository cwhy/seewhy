"""
Generate and upload a report for variations exp1.
...
Produces:
  ...
  - Local report: projects/variations/report_exp1.md  (relative paths, works offline)
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp1.py
"""
...
from experiments1 import encode, decode, LATENT_DIM, N_BITS
...
md_local = f"""# variations — exp1 report

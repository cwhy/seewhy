"""
Generate and upload a report for variations exp28 (CIFAR-10, N_VAR=128).

Usage:
    uv run python projects/variations/scripts/gen_report_exp28.py
"""
...
md_local = f"""# variations — exp28 report (CIFAR-10, N_VAR={N_VAR_SAMPLES})

**Algorithm**: CNN encoder + wide deconvnet decoder. Primary change: N_VAR_SAMPLES={N_VAR_SAMPLES} (was 64 in exp23).
...
| N_VAR_SAMPLES | {N_VAR_SAMPLES} (was 64 in exp23) |
| K_NN | {K_NN} |
| ALPHA | {ALPHA} |

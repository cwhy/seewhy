"""
Generate and upload a report for variations exp10.
...
Produces:
  ...
  - Local report: projects/variations/report_exp10.md
  - HTML report uploaded to R2

Usage:
    uv run python projects/variations/scripts/gen_report_exp10.py
"""
...
md_local = f"""# variations — exp10 report

"""
Generate and upload a report for variations exp30 (CIFAR-10, LATENT=1024).

Usage:
    uv run python projects/variations/scripts/gen_report_exp30.py
"""
...
md_local = f"""# variations — exp30 report (CIFAR-10, LATENT={LATENT_DIM})

**Algorithm**: CNN encoder + wide deconvnet decoder. Primary change: LATENT_DIM={LATENT_DIM} (was 512 in exp23), ENC_FC1={ENC_FC1}.
...
| param | value |
|-------|-------|
| LATENT_DIM | {LATENT_DIM} (was 512 in exp23) |

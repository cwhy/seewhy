"""
Generate and upload a report for variations exp35 (CIFAR-10, LATENT=2048, N_VAR=128, warm-start from exp33).

Usage:
    uv run python projects/variations/scripts/gen_report_exp35.py
"""
...
fig.suptitle(f"variations {EXP} — learning curves (CIFAR-10, LATENT={LATENT_DIM}, warm-start exp33)", fontsize=13)
plt.tight_layout()
...
fig.suptitle(f"variations {EXP} — reconstructions (LATENT={LATENT_DIM}, warm-start exp33, CIFAR-10)", fontsize=11)
...
md_local = f"""# variations — exp35 report (CIFAR-10, LATENT={LATENT_DIM}, warm-start exp33)

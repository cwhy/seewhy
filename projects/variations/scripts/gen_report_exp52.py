"""
Generate and upload a full visualisation report for exp52
(VOCAB=64, N_VAR=128, 400ep).

Usage:
    CUDA_VISIBLE_DEVICES=0 uv run python projects/variations/scripts/gen_report_exp52.py
"""
...
ax.set_xlabel("epoch"); ax.set_ylabel("MSE"); ax.set_title("Training loss (VOCAB=64)")
ax.set_yscale("log")
...
fig.suptitle(f"Learning dynamics — {EXP} (CIFAR-10, VOCAB=64, N_VAR=128, 400ep)", fontsize=13)
plt.tight_layout()
...
OUTER_VALS = [(0, 0), (32, 0), (0, 32), (32, 32)]
INNER_SIDE = 8
GRID_SIDE  = 16

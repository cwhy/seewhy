"""
exp17 — Wide decoder on CIFAR-10. CNN encoder (same as exp16) + 2× wider deconvnet decoder.
...
Hypothesis: the 32-channel bottleneck at 16×16 was the primary capacity constraint.
Doubling decoder channels should substantially sharpen outputs.

Estimated ~15M total parameters.

Usage:
    uv run python projects/variations/experiments17.py
"""
...
# CNN encoder channels (unchanged from exp16)
ENC_C1         = 64    # 32×32 → 16×16
ENC_C2         = 128   # 16×16 → 8×8
ENC_C3         = 256   # 8×8   → 4×4
ENC_FC1        = 512   # flatten 4096 → 512

# Decoder architecture — 2× wider than exp16
DC_STEM        = 1024   # was 512
DC_C1          = 256    # was 128
DC_C2          = 128    # was 64
DC_C3          = 64     # was 32
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment":      EXP_NAME,
        "name":            f"Wide decoder CIFAR-10  LATENT={LATENT_DIM} N_CAT={N_CAT} VOCAB={VOCAB_SIZE} N_VAR={N_VAR_SAMPLES} K_NN={K_NN} B={BATCH_SIZE}",

"""
Experiment runner for Random Transformers.

Runs experiments sequentially (default) or in parallel across GPUs.
Logs each experiment to projects/random-transformers/logs/{name}.log and prints a
...
Usage:
    ...
    uv run python projects/random-transformers/scripts/run_experiments.py --viz scripts/gen_viz_exp1.py exp1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run Random Transformers experiments")

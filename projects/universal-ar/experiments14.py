"""
Universal AR — exp14: 5-way, anonymised labels (chance 0.20).

Mid-point of the class-count sweep between exp12 (2-way, 1.000) and exp11
(10-way, chance). Locates where the match-and-copy circuit breaks down.
...
TASK_DIGITS = (0, 1, 2, 3, 4)          # 5-way: midpoint between 2-way (1.000) and 10-way (chance)

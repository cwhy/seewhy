"""
Universal AR — exp4: variant A (self-recall) + ref self-recall, optimized.
...
if __name__ == "__main__":
    ...
    row = {
        "experiment": EXP_NAME,
        "name": "variant A + ref self-recall, device-sampled/optimized, scaled up",

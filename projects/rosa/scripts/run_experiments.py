"""
Experiment runner for ROSA.

Runs experiments sequentially (default) or in parallel across GPUs.
Logs each experiment to projects/rosa/logs/{name}.log and prints a
...
Usage:
    ...
    uv run python projects/rosa/scripts/run_experiments.py --viz scripts/gen_viz_exp1.py exp1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run ROSA experiments")

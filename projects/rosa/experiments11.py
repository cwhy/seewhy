...
EXP_NAME            = "exp11_fmnist"
USE_ROSA_FEAT       = False           # exp11: zero out ROSA's predicted-token embedding
...
N_TRAIN             = 10_000        # subset for speed
N_TEST              = 10_000
BATCH_SIZE          = 64
N_EPOCHS            = 30
SEED                = 42
...
def main():
    ...
    final_train = eval_test(p, rosa, X_train, y_train)
    ...
    row = {
        "experiment": EXP_NAME,
        "name": f"eggroll-NO-rosa-{DATASET}",
        "dataset": DATASET,
        "test_acc": final_test,

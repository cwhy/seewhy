"""
Experiment runner for ema-viz.

Runs experiments sequentially (default) or in parallel across GPUs.
Logs each experiment to projects/ema-viz/logs/{name}.log and prints a
...
Usage:
    ...
    uv run python projects/ema-viz/scripts/run_experiments.py --parallel exp1 exp2
    ...
    uv run python projects/ema-viz/scripts/run_experiments.py --viz scripts/gen_viz_exp1.py exp1
"""
...
def main():
    parser = argparse.ArgumentParser(description="Run ema-viz experiments")

"""
Universal Transformer with Memory on Sudoku-Extreme (exp17).
Continuation of exp16 (56.32% after 24 epochs, D=768 7M). LR=1e-5, 8 more epochs.
Usage: uv run python projects/utm/scripts/run_experiments.py exp17
"""
...
LR             = 1e-5                         # further reduced LR for fine-tuning
BATCH_SIZE     = 64
N_EPOCHS       = 8
EMA_DECAY      = 0.999
WEIGHT_DECAY   = 0.01
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment":     EXP_NAME,
        "name":           f"UTM cont-exp16 lr=1e-5 D={D_MODEL} remat bs={BATCH_SIZE} K={K_PONDER} T={N_MEM} 7M",
        "d_model":        D_MODEL,
        "n_heads":        N_HEADS,
        "head_dim":       HEAD_DIM,
        "ffn_dim":        FFN_DIM,

"""
Universal Transformer with Memory on Sudoku-Extreme (exp6).
Continuation of exp4: loads exp4's EMA checkpoint (51.49% after 8 epochs) and trains
for 8 more epochs with a fresh cosine LR schedule. Targets 57%+ to match the paper.
Usage: uv run python projects/utm/scripts/run_experiments.py exp6
"""
...
N_EPOCHS       = 8                            # 8 more epochs on top of exp4's 8
...
SEED           = 42
EXP_NAME       = "exp6"
CHECKPOINT_FROM = "exp4"                      # warm-start from this experiment's EMA params
# fmt: on
...
if __name__ == "__main__":
    ...
    append_result({
        "experiment":     EXP_NAME,
        "name":           f"UTM cont-from-exp4 lr=1e-4 bs=128 D={D_MODEL} K={K_PONDER} T={N_MEM} 8ep",
        "d_model":        D_MODEL,
        "n_heads":        N_HEADS,
        "head_dim":       HEAD_DIM,
        "ffn_dim":        FFN_DIM,

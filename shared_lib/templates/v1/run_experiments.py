"""
Experiment runner for {PROJECT_NAME}.

Runs experiments sequentially (default) or in parallel across GPUs.
Logs each experiment to projects/{project-name}/logs/{name}.log and prints a
...
Usage:
    ...
    uv run python projects/{project-name}/scripts/run_experiments.py --viz scripts/gen_viz_exp1.py exp1
"""
